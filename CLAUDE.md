...
Behavioral rules for Claude Code in the gels repository.

## Project Overview

Trait-based grammar inference engine

Part of the [rhi ecosystem](https://rhi.zone).

## Architecture

Trait-based grammar inference engine. Detects syntactic traits from example files,
identifies known languages or synthesizes tree-sitter grammars for unknown ones.

Pipeline: `examples → tokenize → detect traits → identify or synthesize → tree-sitter grammar`
...
- **gels** — CLI and public library API
